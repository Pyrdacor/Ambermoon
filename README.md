...
[v1.0.51 for Windows](https://github.com/Pyrdacor/Ambermoon/releases/download/v1.0.51/AmbermoonTools-Windows.zip): Current release with a command line packer and a command line monster value changer.
