...
if ($isWindows) {
  ...
  dotnet publish -c $env:CONFIGURATION "./AmbermoonTools/MonsterValueChanger/MonsterValueChanger.csproj" -p:PublishSingleFile=true -r win-x86 --no-restore --no-self-contained --nologo
  dotnet publish -c $env:CONFIGURATION "./AmbermoonTools/MonsterValueChanger/MonsterValueChanger.csproj" -p:PublishSingleFile=true -r win-x64 --no-restore --no-self-contained --nologo
  ...
  dotnet publish -c $env:CONFIGURATION "./AmbermoonTools/MonsterValueChanger/MonsterValueChanger.csproj" -p:PublishSingleFile=true -r linux-x64 --no-restore --no-self-contained --nologo
