...
if ($isWindows) {
  ...
  7z a AmbermoonTools-Linux.tar "./AmbermoonTools/AmbermoonPack/bin/Any CPU/Release/netcoreapp3.1/linux-x64/publish/AmbermoonPack"
  7z a AmbermoonTools-Linux.tar "./AmbermoonTools/MonsterValueChanger/bin/Any CPU/Release/netcoreapp3.1/linux-x64/publish/MonsterValueChanger"
  7z a AmbermoonTools-Linux.tar "./AmbermoonTools/AmbermoonTextImport/bin/Any CPU/Release/netcoreapp3.1/linux-x64/publish/AmbermoonTextImport"
