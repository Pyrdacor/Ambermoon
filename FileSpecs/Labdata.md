...
0x0002 | uword | Default combat background index (only in the lower 4 bits). The rest seems to be unused even in original code. Is ignored for walls and can be overridden by map characters.
